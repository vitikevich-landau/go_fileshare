...
> админ). M12–M18 (пользователи, upload и квоты, TLS, корзина и версии,
> публичные ссылки, синхронизация, эксплуатация) — перспектива, здесь не
> реализуются, но модель данных под них закладывается так же, как в C++. Их
> состав нормативно задан в [10-cloud-drive-spec.md](10-cloud-drive-spec.md) §25.
